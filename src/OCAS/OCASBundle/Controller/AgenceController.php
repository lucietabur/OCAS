...
class AgenceController extends Controller
{
  ...
  public function addAction(Request $request)
  {
      ...
      if ($form->isSubmitted() && $form->isValid()) {
          ...
          $request->getSession()->getFlashBag()->add('notice', 'Agence bien enregistré•e.');
          return $this->redirectToRoute('agence_list');
      }
      return $this->render('@OCAS/Agence/form.html.twig', array(
        'h1' => "OCAS : Ajouter un agence",
  ...
  public function editAction($id, Request $request)
  {
      ...
      if ($id == null) {
          $request->getSession()->getFlashBag()->add('notice', "Le agence demandé n'a pas pu être trouvé");
          return $this->redirectToRoute('agence_list');
      ...
      if ($form->isSubmitted() && $form->isValid()) {
          ...
          $em->persist($agence);
          $em->flush();
          $request->getSession()->getFlashBag()->add('notice', 'Agence bien modifié•e');
          return $this->redirectToRoute('agence_list');
      }
  ...
  public function deleteAction($id, Request $request)
  {
      ...
      if (null === $agence) {
          throw new NotFoundHttpException("Le agence demandée n'existe pas");
      }
      ...
      if ($request->isMethod('POST') && $form->handleRequest($request)->isValid()) {
          ...
          $request->getSession()->getFlashBag()->add('info', "Le agence a bien été supprimée");
