 ...
 * @ORM\Entity(repositoryClass="OCASBundle\Repository\FormateurRepository")
 */
class Formateur
{
    /**
    ...
    /**
    * @ORM\OneToMany(targetEntity="OCASBundle\Entity\Feuille_emargement", mappedBy="formateur")
