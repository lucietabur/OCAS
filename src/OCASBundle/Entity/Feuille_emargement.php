 ...
 * @ORM\Entity(repositoryClass="OCASBundle\Repository\Feuille_emargementRepository")
 */
class Feuille_emargement
{
     ...
     * @var int
     *
     * @ORM\Column(name="num_emargement", type="integer", unique=true)
     */
    ...
    /**
    * @ORM\ManyToOne(targetEntity="OCASBundle\Entity\Formateur", inversedBy="feuille_emargement")
    */
    private $formateur;

    /**
    * @ORM\ManyToOne(targetEntity="OCASBundle\Entity\Formation", inversedBy="feuille_emargement")
    */
    private $formation;
     ...
     * Add formateur
     *
     * @param \OCASBundle\Entity\Formateur $formateur
     *
     * @return Feuille_emargement
     */
    public function addFormateur(\OCASBundle\Entity\Formateur $formateur)
    {
     ...
     * @param \OCASBundle\Entity\Formateur $formateur
     */
    public function removeFormateur(\OCASBundle\Entity\Formateur $formateur)
    {
     ...
     * Add formation
     *
     * @param \OCASBundle\Entity\Formation $formation
     *
     * @return Feuille_emargement
     */
    public function addFormation(\OCASBundle\Entity\Formation $formation)
    {
     ...
     * @param \OCASBundle\Entity\Formation $formation
     */
    public function removeFormation(\OCASBundle\Entity\Formation $formation)
    {
     ...
     *
     * @param \OCASBundle\Entity\Formation $detailEmargement
     *
     * @return Feuille_emargement
     */
    public function addDetailEmargement(\OCASBundle\Entity\Formation $detailEmargement)
    {
     ...
     * @param \OCASBundle\Entity\Formation $detailEmargement
     */
    public function removeDetailEmargement(\OCASBundle\Entity\Formation $detailEmargement)
    {
