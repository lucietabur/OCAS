 ...
 * @ORM\Entity(repositoryClass="OCASBundle\Repository\Detail_emargementRepository")
 */
class Detail_emargement
{
    ...
    /**
    * @ORM\ManyToOne(targetEntity="OCASBundle\Entity\Feuille_emargement")
    */
    private $feuille_emargement;

    /**
    * @ORM\ManyToOne(targetEntity="OCASBundle\Entity\Stagiaire")
    ...
    */
     ...
     * Set stagiaire
     *
     * @param \OCASBundle\Entity\Stagiaire $stagiaire
     *
     * @return Detail_emargement
     */
    public function setStagiaire(\OCASBundle\Entity\Stagiaire $stagiaire)
    {
     ...
     * Get stagiaire
     *
     * @return \OCASBundle\Entity\Stagiaire
     */
